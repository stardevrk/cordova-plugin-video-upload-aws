...
@protocol AAMultiSelectViewControllerDelegate;

@interface AAMultiSelectViewController : UIViewController

@property (nonatomic, weak) id <AAMultiSelectViewControllerDelegate> delegate;
...
@protocol AAMultiSelectViewControllerDelegate <NSObject>
