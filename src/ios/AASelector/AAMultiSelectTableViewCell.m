...
//        _selectedImageView.image = AAImage(@"AAicon_check.png");
        _selectedImageView.image = [UIImage imageNamed:@"AAicon_check" inBundle:[NSBundle bundleForClass:AAMultiSelectTableViewCell.class] compatibleWithTraitCollection:nil];
    }
